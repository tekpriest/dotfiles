return {
  ...
  init = function()
    ...
    local extensions = {
      'json', 'git', 'html', 'prettier',
      'tsserver', 'css', 'docker', 'elixir',
      'emmet', 'erlang_ls', 'fzf-preview', 'go',
      'golines', 'highlight', 'lua', 'nav',
      'prisma', 'sh', 'sql', 'swagger', 'toml', 'yaml'
    }

    for _, extension in pairs(extensions) do
      table.insert(global_extensions, 'coc-' .. extension)
    end
