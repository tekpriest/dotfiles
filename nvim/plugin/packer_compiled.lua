...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-npm", "cmp-nvim-lsp-signature-help", "cmp-nvim-lsp-document-symbol", "cmp_luasnip", "cmp-nvim-lsp", "cmp-path", "cmp-buffer" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-rainbow", "playground", "nvim-ts-context-commentstring", "nvim-ts-autotag" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'FixCursorHold.nvim', 'nvim-cmp'}, { event = "BufRead *" }, _G.packer_plugins)]]
